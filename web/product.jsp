    ...
    <body>
        <c:if test="${sessionScope.USER.roleID ne 'AD'}">
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="categories">
                            ...
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15674.421280136332!2d106.80129289627072!3d10.841485705973176!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31752731176b07b1%3A0xb752b24b379bae5e!2zVHLGsOG7nW5nIMSQ4bqhaSBo4buNYyBGUFQgVFAuIEhDTQ!5e0!3m2!1svi!2s!4v1646668512219!5m2!1svi!2s" width="250" height="500" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                        </div>
                    </div>
                    <div class="col-lg-9">
                        ...
                        <div class="hero__item set-bg">
                            <a target="_blank" href="https://www.bachhoaxanh.com/khuyen-mai/chuong-trinh-khuyen-mai-tet-ct450">
                                <img src="https://cdn.tgdd.vn/bachhoaxanh/banners/2505/giat-xa-thai-lan-mua-2-tang-1-2402202203147.jpg"
                                     alt="Picture" style="width: 95%;">
                            </a>
                            <a target="_blank" href="https://www.bachhoaxanh.com/banh-caramen-banh-flan-anh-hong">
                                <img src="https://cdn.tgdd.vn/bachhoaxanh/banners/2505/banh-flan-mua-5-tang-1-21022022162022.jpg"
                                     alt="picture" style="width: 95%;">
                            </a>
            ...
            <form action="MainController" method="GET"  class="row search-product" style="width: 1903px; display: flex; justify-content: center; margin-bottom: 30px;">
                ...
                <span style="padding-top: 6px; padding-left: 5px;">VND</span>
                <div>
                ...
                <div style="width: 1510px;display: flex;flex-wrap: wrap; justify-content: center;"
                    ...
                    <c:forEach items="${sessionScope.LISTPRODUCT}" var="listProdcut">
                        <div class="products"
                            ...
                            <p style="text-align: center;font-size: large "><fmt:formatNumber type = "number" maxFractionDigits = "0" value = "${listProdcut.price}" /> VND</p>
                        ...
                        <nav class="navbar navbar-expand-lg navbar-light bg-light static-top mb-5"
                            ...
                            <div class="container" style="display: flex;justify-content: center;">
                                ...
                                <div class="collapse navbar-collapse" id="navbarResponsive">
                                    <ul class="navbar-nav ml-auto">
                                        <li class="nav-item">
                                            <a class="nav-link" href="MainController?btnAction=SearchAd">Product
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="MainController?btnAction=order">Order
                                            </a>
                                        </li>
                                    </ul>
